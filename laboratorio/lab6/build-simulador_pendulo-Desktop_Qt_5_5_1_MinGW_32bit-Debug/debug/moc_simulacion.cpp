...
#include "../../simulador_pendulo/simulacion.h"
...
QT_MOC_LITERAL(3, 18, 10) // "actualizar"

    },
    "Simulacion\0start\0\0actualizar"
};
...
const QMetaObject Simulacion::staticMetaObject = {
    { &QMainWindow::staticMetaObject, qt_meta_stringdata_Simulacion.data,
      qt_meta_data_Simulacion,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *Simulacion::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Simulacion.stringdata0))
        return static_cast<void*>(const_cast< Simulacion*>(this));
